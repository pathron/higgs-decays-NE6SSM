 ...
 */
double NE6SSM_soft_parameters::calc_beta_mHpbar2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NE6SSM_soft_parameters::calc_beta_mHpbar2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHpbar2 = 0.02*twoLoop*(6*Conj(MassB)*Sqr(g1)*(261*MassB*Sqr(g1)
      + 8*(2*MassB + MassBp)*Sqr(g1p) + 15*(2*MassB + MassWB)*Sqr(g2)) + 10*(30
