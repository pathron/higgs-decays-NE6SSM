{4*Cp[USd[{gO1}], conj[USd[{gO2}]], conj[VWm], VWm]*
  ...
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
   ...
   A0[Mass2[SHp0[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], conj[SHp0[{gI1}]], 
     SHp0[{gI1}]]] - sum[gI1, 1, 2, A0[Mass2[SHpp[{gI1}]]]*
    Cp[USd[{gO1}], conj[USd[{gO2}]], conj[SHpp[{gI1}]], SHpp[{gI1}]]] - 
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
     conj[Sv[{gI1}]], Sv[{gI1}]]] - 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 2, G0[p^2, Mass2[Fu[{gI1}]], Mass2[Cha[{gI2}]]]*
     (conj[Cp[conj[USd[{gO2}]], Fu[{gI1}], Cha[{gI2}]][PL]]*
      ...
      conj[Cp[conj[USd[{gO2}]], Fu[{gI1}], Cha[{gI2}]][PR]]*
       Cp[conj[USd[{gO1}]], Fu[{gI1}], Cha[{gI2}]][PR])]] - 
  2*sum[gI1, 1, 3, Mass[Fd[{gI1}]]*sum[gI2, 1, 8, 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 8, G0[p^2, Mass2[Fd[{gI1}]], Mass2[Chi[{gI2}]]]*
     (conj[Cp[conj[USd[{gO2}]], Fd[{gI1}], Chi[{gI2}]][PL]]*
       Cp[conj[USd[{gO1}]], Fd[{gI1}], Chi[{gI2}]][PL] + 
      conj[Cp[conj[USd[{gO2}]], Fd[{gI1}], Chi[{gI2}]][PR]]*
       Cp[conj[USd[{gO1}]], Fd[{gI1}], Chi[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  C*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  C*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
  ...
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[Sd[{gI1}]], Mass2[Ah[{gI2}]]]*
     conj[Cp[conj[USd[{gO2}]], Sd[{gI1}], Ah[{gI2}]]]*
     Cp[conj[USd[{gO1}]], Sd[{gI1}], Ah[{gI2}]]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[Sd[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USd[{gO2}]], VZ, Sd[{gI2}]]]*
    ...
    Cp[conj[USd[{gO1}]], VZp, Sd[{gI2}]]*F0[p^2, Mass2[Sd[{gI2}]], 
     Mass2[VZp]]] + sum[gI2, 1, 6, conj[Cp[conj[USd[{gO2}]], VWm, Su[{gI2}]]]*
  ...
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], conj[SHp0[{gI1}]], 
     SHp0[{gI1}]]] - sum[gI1, 1, 2, A0[Mass2[SHpp[{gI1}]]]*
    Cp[USv[{gO1}], conj[USv[{gO2}]], conj[SHpp[{gI1}]], SHpp[{gI1}]]] - 
  ...
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
   ...
   sum[gI2, 1, 5, B0[p^2, Mass2[Sv[{gI1}]], Mass2[hh[{gI2}]]]*
     conj[Cp[conj[USv[{gO2}]], Sv[{gI1}], hh[{gI2}]]]*
     Cp[conj[USv[{gO1}]], Sv[{gI1}], hh[{gI2}]]]] - 
  2*sum[gI1, 1, 3, Mass[Fv[{gI1}]]*sum[gI2, 1, 8, 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 8, G0[p^2, Mass2[Fv[{gI1}]], Mass2[Chi[{gI2}]]]*
     (conj[Cp[conj[USv[{gO2}]], Fv[{gI1}], Chi[{gI2}]][PL]]*
       Cp[conj[USv[{gO1}]], Fv[{gI1}], Chi[{gI2}]][PL] + 
      conj[Cp[conj[USv[{gO2}]], Fv[{gI1}], Chi[{gI2}]][PR]]*
       Cp[conj[USv[{gO1}]], Fv[{gI1}], Chi[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
  ...
  sum[gI2, 1, 3, conj[Cp[conj[USv[{gO2}]], VZ, Sv[{gI2}]]]*
    Cp[conj[USv[{gO1}]], VZ, Sv[{gI2}]]*F0[p^2, Mass2[Sv[{gI2}]], 
     Mass2[VZ]]] + sum[gI2, 1, 3, conj[Cp[conj[USv[{gO2}]], VZp, Sv[{gI2}]]]*
  ...
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], conj[SHp0[{gI1}]], 
     SHp0[{gI1}]]] - sum[gI1, 1, 2, A0[Mass2[SHpp[{gI1}]]]*
    Cp[USu[{gO1}], conj[USu[{gO2}]], conj[SHpp[{gI1}]], SHpp[{gI1}]]] - 
  2*sum[gI1, 1, 2, Mass[Cha[{gI1}]]*sum[gI2, 1, 3, 
  ...
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
     conj[Sv[{gI1}]], Sv[{gI1}]]] - 
  2*sum[gI1, 1, 3, Mass[Fu[{gI1}]]*sum[gI2, 1, 8, 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 8, G0[p^2, Mass2[Fu[{gI1}]], Mass2[Chi[{gI2}]]]*
     (conj[Cp[conj[USu[{gO2}]], Fu[{gI1}], Chi[{gI2}]][PL]]*
       Cp[conj[USu[{gO1}]], Fu[{gI1}], Chi[{gI2}]][PL] + 
      conj[Cp[conj[USu[{gO2}]], Fu[{gI1}], Chi[{gI2}]][PR]]*
       Cp[conj[USu[{gO1}]], Fu[{gI1}], Chi[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  C*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  C*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
   A0[Mass2[Se[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], conj[Se[{gI1}]], 
     Se[{gI1}]]] - C*sum[gI1, 1, 6, A0[Mass2[Su[{gI1}]]]*
     Cp[USu[{gO1}], conj[USu[{gO2}]], conj[Su[{gI1}]], Su[{gI1}]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[Su[{gI1}]], Mass2[Ah[{gI2}]]]*
     conj[Cp[conj[USu[{gO2}]], Su[{gI1}], Ah[{gI2}]]]*
     Cp[conj[USu[{gO1}]], Su[{gI1}], Ah[{gI2}]]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[Su[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USu[{gO2}]], VZ, Su[{gI2}]]]*
    ...
    Cp[conj[USu[{gO1}]], VZp, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
     Mass2[VZp]]], 4*Cp[USe[{gO1}], conj[USe[{gO2}]], conj[VWm], VWm]*
   (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
  ...
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], conj[SHp0[{gI1}]], 
     SHp0[{gI1}]]] - sum[gI1, 1, 2, A0[Mass2[SHpp[{gI1}]]]*
    Cp[USe[{gO1}], conj[USe[{gO2}]], conj[SHpp[{gI1}]], SHpp[{gI1}]]] - 
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
     conj[Sv[{gI1}]], Sv[{gI1}]]] + sum[gI1, 1, 3, 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 2, G0[p^2, Mass2[Fv[{gI1}]], Mass2[Cha[{gI2}]]]*
     (conj[Cp[conj[USe[{gO2}]], Fv[{gI1}], Cha[{gI2}]][PL]]*
      ...
      conj[Cp[conj[USe[{gO2}]], Fv[{gI1}], Cha[{gI2}]][PR]]*
       Cp[conj[USe[{gO1}]], Fv[{gI1}], Cha[{gI2}]][PR])]] - 
  2*sum[gI1, 1, 3, Mass[Fe[{gI1}]]*sum[gI2, 1, 8, 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 8, G0[p^2, Mass2[Fe[{gI1}]], Mass2[Chi[{gI2}]]]*
     (conj[Cp[conj[USe[{gO2}]], Fe[{gI1}], Chi[{gI2}]][PL]]*
       Cp[conj[USe[{gO1}]], Fe[{gI1}], Chi[{gI2}]][PL] + 
      conj[Cp[conj[USe[{gO2}]], Fe[{gI1}], Chi[{gI2}]][PR]]*
       Cp[conj[USe[{gO1}]], Fe[{gI1}], Chi[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
   A0[Mass2[Se[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], conj[Se[{gI1}]], 
     Se[{gI1}]]] - 3*sum[gI1, 1, 6, A0[Mass2[Su[{gI1}]]]*
     Cp[USe[{gO1}], conj[USe[{gO2}]], conj[Su[{gI1}]], Su[{gI1}]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[Se[{gI1}]], Mass2[Ah[{gI2}]]]*
     conj[Cp[conj[USe[{gO2}]], Se[{gI1}], Ah[{gI2}]]]*
     Cp[conj[USe[{gO1}]], Se[{gI1}], Ah[{gI2}]]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[Se[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USe[{gO2}]], VZ, Se[{gI2}]]]*
    ...
    Cp[conj[USe[{gO1}]], VZp, Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
     Mass2[VZp]]], 2*Cp[USDX[{gO1}], conj[USDX[{gO2}]], VZ, VZ]*
   (A0[Mass2[VZ]] - (rMS*Mass2[VZ])/2) + 
  2*Cp[USDX[{gO1}], conj[USDX[{gO2}]], VZp, VZp]*
   (A0[Mass2[VZp]] - (rMS*Mass2[VZp])/2) - 
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
     conj[SHp0[{gI1}]], SHp0[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHpp[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
     conj[SHpp[{gI1}]], SHpp[{gI1}]]] - sum[gI1, 1, 3, 
   A0[Mass2[Sv[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], conj[Sv[{gI1}]], 
     Sv[{gI1}]]] - 2*sum[gI1, 1, 3, Mass[FDX[{gI1}]]*
     sum[gI2, 1, 8, B0[p^2, Mass2[FDX[{gI1}]], Mass2[Chi[{gI2}]]]*
       Mass[Chi[{gI2}]]*(conj[Cp[conj[USDX[{gO2}]], FDX[{gI1}], Chi[{gI2}]][
           PR]]*Cp[conj[USDX[{gO1}]], FDX[{gI1}], Chi[{gI2}]][PL] + 
        conj[Cp[conj[USDX[{gO2}]], FDX[{gI1}], Chi[{gI2}]][PL]]*
         Cp[conj[USDX[{gO1}]], FDX[{gI1}], Chi[{gI2}]][PR])]] + 
  sum[gI1, 1, 3, sum[gI2, 1, 8, G0[p^2, Mass2[FDX[{gI1}]], Mass2[Chi[{gI2}]]]*
     (conj[Cp[conj[USDX[{gO2}]], FDX[{gI1}], Chi[{gI2}]][PL]]*
       Cp[conj[USDX[{gO1}]], FDX[{gI1}], Chi[{gI2}]][PL] + 
      conj[Cp[conj[USDX[{gO2}]], FDX[{gI1}], Chi[{gI2}]][PR]]*
       Cp[conj[USDX[{gO1}]], FDX[{gI1}], Chi[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  C*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  C*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
   A0[Mass2[Se[{gI1}]]]*Cp[USDX[{gO1}], conj[USDX[{gO2}]], conj[Se[{gI1}]], 
     Se[{gI1}]]] - C*sum[gI1, 1, 6, A0[Mass2[Su[{gI1}]]]*
     Cp[USDX[{gO1}], conj[USDX[{gO2}]], conj[Su[{gI1}]], Su[{gI1}]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[SDX[{gI1}]], Mass2[Ah[{gI2}]]]*
     conj[Cp[conj[USDX[{gO2}]], SDX[{gI1}], Ah[{gI2}]]]*
     Cp[conj[USDX[{gO1}]], SDX[{gI1}], Ah[{gI2}]]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 5, B0[p^2, Mass2[SDX[{gI1}]], Mass2[hh[{gI2}]]]*
     conj[Cp[conj[USDX[{gO2}]], SDX[{gI1}], hh[{gI2}]]]*
     Cp[conj[USDX[{gO1}]], SDX[{gI1}], hh[{gI2}]]]] - 
  (8*Mass[Glu]*sum[gI2, 1, 3, B0[p^2, Mass2[Glu], Mass2[FDX[{gI2}]]]*
      Mass[FDX[{gI2}]]*(conj[Cp[conj[USDX[{gO2}]], Glu[{1}], FDX[{gI2}]][PR]]*
        Cp[conj[USDX[{gO1}]], Glu[{1}], FDX[{gI2}]][PL] + 
       conj[Cp[conj[USDX[{gO2}]], Glu[{1}], FDX[{gI2}]][PL]]*
        Cp[conj[USDX[{gO1}]], Glu[{1}], FDX[{gI2}]][PR])])/3 + 
  (4*sum[gI2, 1, 3, G0[p^2, Mass2[Glu], Mass2[FDX[{gI2}]]]*
      (conj[Cp[conj[USDX[{gO2}]], Glu[{1}], FDX[{gI2}]][PL]]*
        Cp[conj[USDX[{gO1}]], Glu[{1}], FDX[{gI2}]][PL] + 
       conj[Cp[conj[USDX[{gO2}]], Glu[{1}], FDX[{gI2}]][PR]]*
        Cp[conj[USDX[{gO1}]], Glu[{1}], FDX[{gI2}]][PR])])/3 + 
  (4*sum[gI2, 1, 6, conj[Cp[conj[USDX[{gO2}]], VG, SDX[{gI2}]]]*
      Cp[conj[USDX[{gO1}]], VG, SDX[{gI2}]]*F0[p^2, Mass2[SDX[{gI2}]], 0]])/
   3 + sum[gI2, 1, 6, conj[Cp[conj[USDX[{gO2}]], VP, SDX[{gI2}]]]*
    Cp[conj[USDX[{gO1}]], VP, SDX[{gI2}]]*F0[p^2, Mass2[SDX[{gI2}]], 0]] + 
  sum[gI2, 1, 6, conj[Cp[conj[USDX[{gO2}]], VZ, SDX[{gI2}]]]*
    Cp[conj[USDX[{gO1}]], VZ, SDX[{gI2}]]*F0[p^2, Mass2[SDX[{gI2}]], 
     Mass2[VZ]]] + sum[gI2, 1, 6, 
   conj[Cp[conj[USDX[{gO2}]], VZp, SDX[{gI2}]]]*Cp[conj[USDX[{gO1}]], VZp, 
     SDX[{gI2}]]*F0[p^2, Mass2[SDX[{gI2}]], Mass2[VZp]]], 
 2*(-rMS/2 + B0[p^2, Mass2[VZ], Mass2[VZ]])*conj[Cp[Uhh[{gO2}], VZ, VZ]]*
  ...
  2*(-rMS/2 + B0[p^2, Mass2[VZp], Mass2[VZp]])*conj[Cp[Uhh[{gO2}], VZp, VZp]]*
   Cp[Uhh[{gO1}], VZp, VZp] + 4*(-rMS/2 + B0[p^2, Mass2[VWm], Mass2[VWm]])*
  ...
  sum[gI1, 1, 2, A0[Mass2[SHp0[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], 
     conj[SHp0[{gI1}]], SHp0[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHpp[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], conj[SHpp[{gI1}]], 
     SHpp[{gI1}]]] + sum[gI1, 1, 2, sum[gI2, 1, 2, 
    B0[p^2, Mass2[Hpm[{gI1}]], Mass2[Hpm[{gI2}]]]*
     conj[Cp[Uhh[{gO2}], conj[Hpm[{gI1}]], Hpm[{gI2}]]]*
     Cp[Uhh[{gO1}], conj[Hpm[{gI1}]], Hpm[{gI2}]]]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[SHp0[{gI1}]], 
      Mass2[SHp0[{gI2}]]]*conj[Cp[Uhh[{gO2}], conj[SHp0[{gI1}]], 
       SHp0[{gI2}]]]*Cp[Uhh[{gO1}], conj[SHp0[{gI1}]], SHp0[{gI2}]]]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[SHpp[{gI1}]], 
      Mass2[SHpp[{gI2}]]]*conj[Cp[Uhh[{gO2}], conj[SHpp[{gI1}]], 
       SHpp[{gI2}]]]*Cp[Uhh[{gO1}], conj[SHpp[{gI1}]], SHpp[{gI2}]]]] - 
  ...
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fd[{gI1}]], Mass2[Fd[{gI2}]]]*
      (conj[Cp[Uhh[{gO2}], bar[Fd[{gI1}]], Fd[{gI2}]][PL]]*
       ...
       conj[Cp[Uhh[{gO2}], bar[Fd[{gI1}]], Fd[{gI2}]][PR]]*
        Cp[Uhh[{gO1}], bar[Fd[{gI1}]], Fd[{gI2}]][PR])]] - 
  6*sum[gI1, 1, 3, Mass[FDX[{gI1}]]*sum[gI2, 1, 3, 
      B0[p^2, Mass2[FDX[{gI1}]], Mass2[FDX[{gI2}]]]*Mass[FDX[{gI2}]]*
       (conj[Cp[Uhh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][PR]]*
         Cp[Uhh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PL] + 
        conj[Cp[Uhh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][PL]]*
         Cp[Uhh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PR])]] + 
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[FDX[{gI1}]], 
       Mass2[FDX[{gI2}]]]*(conj[Cp[Uhh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][
          PL]]*Cp[Uhh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PL] + 
       conj[Cp[Uhh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][PR]]*
        Cp[Uhh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PR])]] - 
  ...
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fu[{gI1}]], Mass2[Fu[{gI2}]]]*
      (conj[Cp[Uhh[{gO2}], bar[Fu[{gI1}]], Fu[{gI2}]][PL]]*
       ...
       conj[Cp[Uhh[{gO2}], bar[Fu[{gI1}]], Fu[{gI2}]][PR]]*
        Cp[Uhh[{gO1}], bar[Fu[{gI1}]], Fu[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], Ah[{gI1}], 
      Ah[{gI1}]]]/2 - sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*
     Cp[Uhh[{gO1}], Uhh[{gO2}], hh[{gI1}], hh[{gI1}]]]/2 + 
  sum[gI1, 1, 5, sum[gI2, 1, 5, B0[p^2, Mass2[Ah[{gI1}]], Mass2[Ah[{gI2}]]]*
      conj[Cp[Uhh[{gO2}], Ah[{gI1}], Ah[{gI2}]]]*Cp[Uhh[{gO1}], Ah[{gI1}], 
       Ah[{gI2}]]]]/2 + sum[gI1, 1, 5, sum[gI2, 1, 5, 
    B0[p^2, Mass2[hh[{gI1}]], Mass2[Ah[{gI2}]]]*
     conj[Cp[Uhh[{gO2}], hh[{gI1}], Ah[{gI2}]]]*Cp[Uhh[{gO1}], hh[{gI1}], 
      Ah[{gI2}]]]] + sum[gI1, 1, 5, sum[gI2, 1, 5, 
     B0[p^2, Mass2[hh[{gI1}]], Mass2[hh[{gI2}]]]*
      conj[Cp[Uhh[{gO2}], hh[{gI1}], hh[{gI2}]]]*Cp[Uhh[{gO1}], hh[{gI1}], 
       hh[{gI2}]]]]/2 - 3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*
     Cp[Uhh[{gO1}], Uhh[{gO2}], conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
  ...
  3*sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[SDX[{gI1}]], 
       Mass2[SDX[{gI2}]]]*conj[Cp[Uhh[{gO2}], conj[SDX[{gI1}]], SDX[{gI2}]]]*
      Cp[Uhh[{gO1}], conj[SDX[{gI1}]], SDX[{gI2}]]]] + 
  ...
  sum[gI1, 1, 8, Mass[Chi[{gI1}]]*sum[gI2, 1, 8, 
  ...
  sum[gI1, 1, 8, sum[gI2, 1, 8, G0[p^2, Mass2[Chi[{gI1}]], Mass2[Chi[{gI2}]]]*
      (conj[Cp[Uhh[{gO2}], Chi[{gI1}], Chi[{gI2}]][PL]]*
        Cp[Uhh[{gO1}], Chi[{gI1}], Chi[{gI2}]][PL] + 
       conj[Cp[Uhh[{gO2}], Chi[{gI1}], Chi[{gI2}]][PR]]*
  ...
  2*sum[gI2, 1, 2, conj[Cp[Uhh[{gO2}], conj[VWm], Hpm[{gI2}]]]*
     Cp[Uhh[{gO1}], conj[VWm], Hpm[{gI2}]]*F0[p^2, Mass2[Hpm[{gI2}]], 
      Mass2[VWm]]] + sum[gI2, 1, 5, conj[Cp[Uhh[{gO2}], VZ, Ah[{gI2}]]]*
    Cp[Uhh[{gO1}], VZ, Ah[{gI2}]]*F0[p^2, Mass2[Ah[{gI2}]], Mass2[VZ]]] + 
  sum[gI2, 1, 5, conj[Cp[Uhh[{gO2}], VZp, Ah[{gI2}]]]*
    Cp[Uhh[{gO1}], VZp, Ah[{gI2}]]*F0[p^2, Mass2[Ah[{gI2}]], Mass2[VZp]]], 
 -(B0[p^2, Mass2[gWm], Mass2[gWm]]*Cp[UAh[{gO1}], bar[gWm], gWm]*
  ...
  sum[gI1, 1, 2, A0[Mass2[SHp0[{gI1}]]]*Cp[UAh[{gO1}], UAh[{gO2}], 
     conj[SHp0[{gI1}]], SHp0[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHpp[{gI1}]]]*Cp[UAh[{gO1}], UAh[{gO2}], conj[SHpp[{gI1}]], 
     SHpp[{gI1}]]] + sum[gI1, 1, 2, sum[gI2, 1, 2, 
    B0[p^2, Mass2[Hpm[{gI1}]], Mass2[Hpm[{gI2}]]]*
  ...
  6*sum[gI1, 1, 3, Mass[FDX[{gI1}]]*sum[gI2, 1, 3, 
      B0[p^2, Mass2[FDX[{gI1}]], Mass2[FDX[{gI2}]]]*Mass[FDX[{gI2}]]*
       (conj[Cp[UAh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][PR]]*
         Cp[UAh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PL] + 
        conj[Cp[UAh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][PL]]*
         Cp[UAh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PR])]] + 
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[FDX[{gI1}]], 
       Mass2[FDX[{gI2}]]]*(conj[Cp[UAh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][
          PL]]*Cp[UAh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PL] + 
       conj[Cp[UAh[{gO2}], bar[FDX[{gI1}]], FDX[{gI2}]][PR]]*
        Cp[UAh[{gO1}], bar[FDX[{gI1}]], FDX[{gI2}]][PR])]] - 
  2*sum[gI1, 1, 3, Mass[Fe[{gI1}]]*sum[gI2, 1, 3, 
      B0[p^2, Mass2[Fe[{gI1}]], Mass2[Fe[{gI2}]]]*Mass[Fe[{gI2}]]*
  ...
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fu[{gI1}]], Mass2[Fu[{gI2}]]]*
      (conj[Cp[UAh[{gO2}], bar[Fu[{gI1}]], Fu[{gI2}]][PL]]*
       ...
       conj[Cp[UAh[{gO2}], bar[Fu[{gI1}]], Fu[{gI2}]][PR]]*
        Cp[UAh[{gO1}], bar[Fu[{gI1}]], Fu[{gI2}]][PR])]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[UAh[{gO1}], UAh[{gO2}], Ah[{gI1}], 
      Ah[{gI1}]]]/2 - sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*
    ...
    B0[p^2, Mass2[hh[{gI1}]], Mass2[Ah[{gI2}]]]*
     ...
     B0[p^2, Mass2[hh[{gI1}]], Mass2[hh[{gI2}]]]*
      conj[Cp[UAh[{gO2}], hh[{gI1}], hh[{gI2}]]]*Cp[UAh[{gO1}], hh[{gI1}], 
       hh[{gI2}]]]]/2 - 3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*
     Cp[UAh[{gO1}], UAh[{gO2}], conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[UAh[{gO1}], UAh[{gO2}], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
  ...
  3*sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[SDX[{gI1}]], 
       Mass2[SDX[{gI2}]]]*conj[Cp[UAh[{gO2}], conj[SDX[{gI1}]], SDX[{gI2}]]]*
      Cp[UAh[{gO1}], conj[SDX[{gI1}]], SDX[{gI2}]]]] + 
  sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[Se[{gI1}]], Mass2[Se[{gI2}]]]*
  ...
  2*sum[gI2, 1, 2, conj[Cp[UAh[{gO2}], conj[VWm], Hpm[{gI2}]]]*
     Cp[UAh[{gO1}], conj[VWm], Hpm[{gI2}]]*F0[p^2, Mass2[Hpm[{gI2}]], 
      Mass2[VWm]]] + sum[gI2, 1, 5, conj[Cp[UAh[{gO2}], VZ, hh[{gI2}]]]*
    Cp[UAh[{gO1}], VZ, hh[{gI2}]]*F0[p^2, Mass2[hh[{gI2}]], Mass2[VZ]]] + 
  sum[gI2, 1, 5, conj[Cp[UAh[{gO2}], VZp, hh[{gI2}]]]*
    Cp[UAh[{gO1}], VZp, hh[{gI2}]]*F0[p^2, Mass2[hh[{gI2}]], Mass2[VZp]]], 
 4*(-rMS/2 + B0[p^2, 0, Mass2[VWm]])*conj[Cp[conj[UHpm[{gO2}]], VWm, VP]]*
   Cp[conj[UHpm[{gO1}]], VWm, VP] + 
  ...
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
     conj[SHp0[{gI1}]], SHp0[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHpp[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
     conj[SHpp[{gI1}]], SHpp[{gI1}]]] + sum[gI1, 1, 2, 
   sum[gI2, 1, 2, B0[p^2, Mass2[SHp0[{gI1}]], Mass2[SHpp[{gI2}]]]*
     conj[Cp[conj[UHpm[{gO2}]], conj[SHp0[{gI1}]], SHpp[{gI2}]]]*
     Cp[conj[UHpm[{gO1}]], conj[SHp0[{gI1}]], SHpp[{gI2}]]]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 5, B0[p^2, Mass2[Hpm[{gI1}]], Mass2[Ah[{gI2}]]]*
     conj[Cp[conj[UHpm[{gO2}]], Hpm[{gI1}], Ah[{gI2}]]]*
     Cp[conj[UHpm[{gO1}]], Hpm[{gI1}], Ah[{gI2}]]]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 5, B0[p^2, Mass2[Hpm[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
  ...
  2*sum[gI1, 1, 8, Mass[Chi[{gI1}]]*sum[gI2, 1, 2, 
  ...
  sum[gI1, 1, 8, sum[gI2, 1, 2, G0[p^2, Mass2[Chi[{gI1}]], Mass2[Cha[{gI2}]]]*
     (conj[Cp[conj[UHpm[{gO2}]], Chi[{gI1}], Cha[{gI2}]][PL]]*
       Cp[conj[UHpm[{gO1}]], Chi[{gI1}], Cha[{gI2}]][PL] + 
      conj[Cp[conj[UHpm[{gO2}]], Chi[{gI1}], Cha[{gI2}]][PR]]*
       Cp[conj[UHpm[{gO1}]], Chi[{gI1}], Cha[{gI2}]][PR])]] + 
  ...
  sum[gI2, 1, 5, conj[Cp[conj[UHpm[{gO2}]], VWm, Ah[{gI2}]]]*
    Cp[conj[UHpm[{gO1}]], VWm, Ah[{gI2}]]*F0[p^2, Mass2[Ah[{gI2}]], 
     Mass2[VWm]]] + sum[gI2, 1, 5, 
 ...
 {2*sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[Cha[{gI2}]], 
      ...
      B0[p^2, Mass2[ChiP[{gI2}]], Mass2[SHp0[{gI1}]]]*
       conj[Cp[UChi[{gO2}], conj[SHp0[{gI1}]], ChiP[{gI2}]][PL]]*
       Mass[ChiP[{gI2}]]*Cp[UChi[{gO1}], conj[SHp0[{gI1}]], ChiP[{gI2}]][
        PR]]] + 2*Mass[ChaP]*sum[gI1, 1, 2, 
     B0[p^2, Mass2[ChaP], Mass2[SHpp[{gI1}]]]*
      conj[Cp[UChi[{gO2}], conj[SHpp[{gI1}]], ChaP[{1}]][PL]]*
      Cp[UChi[{gO1}], conj[SHpp[{gI1}]], ChaP[{1}]][PR]] + 
   ...
   6*sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], 
        ...
        PR]]] + 6*sum[gI1, 1, 6, sum[gI2, 1, 3, 
      B0[p^2, Mass2[FDX[{gI2}]], Mass2[SDX[{gI1}]]]*
       conj[Cp[UChi[{gO2}], conj[SDX[{gI1}]], FDX[{gI2}]][PL]]*
       Mass[FDX[{gI2}]]*Cp[UChi[{gO1}], conj[SDX[{gI1}]], FDX[{gI2}]][PR]]] + 
   2*sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], 
        Mass2[Se[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[Se[{gI1}]], Fe[{gI2}]][
         PL]]*Mass[Fe[{gI2}]]*Cp[UChi[{gO1}], conj[Se[{gI1}]], Fe[{gI2}]][
        PR]]] + 6*sum[gI1, 1, 6, sum[gI2, 1, 3, 
      B0[p^2, Mass2[Fu[{gI2}]], Mass2[Su[{gI1}]]]*
       conj[Cp[UChi[{gO2}], conj[Su[{gI1}]], Fu[{gI2}]][PL]]*Mass[Fu[{gI2}]]*
       Cp[UChi[{gO1}], conj[Su[{gI1}]], Fu[{gI2}]][PR]]] + 
   sum[gI1, 1, 8, Mass[Chi[{gI1}]]*sum[gI2, 1, 5, 
      B0[p^2, Mass2[Chi[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[UChi[{gO2}], Chi[{gI1}], Ah[{gI2}]][PL]]*
       Cp[UChi[{gO1}], Chi[{gI1}], Ah[{gI2}]][PR]]] - 
   8*sum[gI2, 1, 2, (-rMS/2 + B0[p^2, Mass2[Cha[{gI2}]], Mass2[VWm]])*
      conj[Cp[UChi[{gO2}], conj[VWm], Cha[{gI2}]][PR]]*Mass[Cha[{gI2}]]*
      Cp[UChi[{gO1}], conj[VWm], Cha[{gI2}]][PL]] - 
   4*sum[gI2, 1, 8, (-rMS/2 + B0[p^2, Mass2[Chi[{gI2}]], Mass2[VZ]])*
      conj[Cp[UChi[{gO2}], VZ, Chi[{gI2}]][PR]]*Mass[Chi[{gI2}]]*
      Cp[UChi[{gO1}], VZ, Chi[{gI2}]][PL]] - 
   4*sum[gI2, 1, 8, (-rMS/2 + B0[p^2, Mass2[Chi[{gI2}]], Mass2[VZp]])*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
   ...
   sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], 
       Mass2[SHp0[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[SHp0[{gI1}]], 
         ChiP[{gI2}]][PR]]*Cp[UChi[{gO1}], conj[SHp0[{gI1}]], ChiP[{gI2}]][
       PR]]] - sum[gI1, 1, 2, B1[p^2, Mass2[ChaP], Mass2[SHpp[{gI1}]]]*
     conj[Cp[UChi[{gO2}], conj[SHpp[{gI1}]], ChaP[{1}]][PR]]*
     Cp[UChi[{gO1}], conj[SHpp[{gI1}]], ChaP[{1}]][PR]] - 
   ...
   sum[gI1, 1, 5, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[hh[{gI1}]]]*
   ...
   3*sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], 
        Mass2[SDX[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[SDX[{gI1}]], FDX[{gI2}]][
         PR]]*Cp[UChi[{gO1}], conj[SDX[{gI1}]], FDX[{gI2}]][PR]]] - 
   ...
   sum[gI1, 1, 8, sum[gI2, 1, 5, B1[p^2, Mass2[Chi[{gI1}]], Mass2[Ah[{gI2}]]]*
   ...
   2*sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], Mass2[VWm]]*
      ...
      Cp[UChi[{gO1}], conj[VWm], Cha[{gI2}]][PL]] - 
   sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[VZ]]*
     conj[Cp[UChi[{gO2}], VZ, Chi[{gI2}]][PL]]*
     Cp[UChi[{gO1}], VZ, Chi[{gI2}]][PL]] - 
   sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[VZp]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
   ...
   sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], 
       Mass2[SHp0[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[SHp0[{gI1}]], 
         ChiP[{gI2}]][PL]]*Cp[UChi[{gO1}], conj[SHp0[{gI1}]], ChiP[{gI2}]][
       PL]]] - sum[gI1, 1, 2, B1[p^2, Mass2[ChaP], Mass2[SHpp[{gI1}]]]*
     conj[Cp[UChi[{gO2}], conj[SHpp[{gI1}]], ChaP[{1}]][PL]]*
     Cp[UChi[{gO1}], conj[SHpp[{gI1}]], ChaP[{1}]][PL]] - 
   sum[gI1, 1, 3, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], Mass2[Sv[{gI1}]]]*
   ...
   3*sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], 
        Mass2[SDX[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[SDX[{gI1}]], FDX[{gI2}]][
         PL]]*Cp[UChi[{gO1}], conj[SDX[{gI1}]], FDX[{gI2}]][PL]]] - 
   sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Se[{gI1}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[ChiP[{gI2}]], 
       Mass2[SHpp[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], SHpp[{gI1}], 
         ChiP[{gI2}]][PL]]*Mass[ChiP[{gI2}]]*
      Cp[bar[UCha[{gO1}]], SHpp[{gI1}], ChiP[{gI2}]][PR]]] + 
   sum[gI1, 1, 2, Mass[Cha[{gI1}]]*sum[gI2, 1, 5, 
      B0[p^2, Mass2[Cha[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UCha[{gO2}]], Cha[{gI1}], Ah[{gI2}]][PL]]*
       Cp[bar[UCha[{gO1}]], Cha[{gI1}], Ah[{gI2}]][PR]]] + 
   sum[gI1, 1, 2, sum[gI2, 1, 8, B0[p^2, Mass2[Chi[{gI2}]], 
       Mass2[Hpm[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], Hpm[{gI1}], Chi[{gI2}]][
        PL]]*Mass[Chi[{gI2}]]*Cp[bar[UCha[{gO1}]], Hpm[{gI1}], Chi[{gI2}]][
       PR]]] + Mass[ChaP]*sum[gI1, 1, 2, 
     B0[p^2, Mass2[ChaP], Mass2[SHp0[{gI1}]]]*
      conj[Cp[bar[UCha[{gO2}]], conj[SHp0[{gI1}]], ChaP[{1}]][PL]]*
      Cp[bar[UCha[{gO1}]], conj[SHp0[{gI1}]], ChaP[{1}]][PR]] + 
   ...
   sum[gI1, 1, 5, sum[gI2, 1, 2, B0[p^2, Mass2[Cha[{gI2}]], Mass2[hh[{gI1}]]]*
   ...
   4*sum[gI2, 1, 8, (-rMS/2 + B0[p^2, Mass2[Chi[{gI2}]], Mass2[VWm]])*
      conj[Cp[bar[UCha[{gO2}]], VWm, Chi[{gI2}]][PR]]*Mass[Chi[{gI2}]]*
      Cp[bar[UCha[{gO1}]], VWm, Chi[{gI2}]][PL]], 
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], 
         Mass2[SHpp[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], SHpp[{gI1}], 
           ChiP[{gI2}]][PR]]*Cp[bar[UCha[{gO1}]], SHpp[{gI1}], ChiP[{gI2}]][
         PR]]]/2 - sum[gI1, 1, 2, sum[gI2, 1, 5, 
      B1[p^2, Mass2[Cha[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UCha[{gO2}]], Cha[{gI1}], Ah[{gI2}]][PR]]*
       Cp[bar[UCha[{gO1}]], Cha[{gI1}], Ah[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 2, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], 
        Mass2[Hpm[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], Hpm[{gI1}], Chi[{gI2}]][
         PR]]*Cp[bar[UCha[{gO1}]], Hpm[{gI1}], Chi[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 2, B1[p^2, Mass2[ChaP], Mass2[SHp0[{gI1}]]]*
      conj[Cp[bar[UCha[{gO2}]], conj[SHp0[{gI1}]], ChaP[{1}]][PR]]*
      Cp[bar[UCha[{gO1}]], conj[SHp0[{gI1}]], ChaP[{1}]][PR]]/2 - 
   ...
   sum[gI1, 1, 5, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], Mass2[hh[{gI1}]]]*
   ...
   sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], Mass2[VZ]]*
     ...
     Cp[bar[UCha[{gO1}]], VZ, Cha[{gI2}]][PL]] - 
   sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], Mass2[VZp]]*
     conj[Cp[bar[UCha[{gO2}]], VZp, Cha[{gI2}]][PL]]*
     Cp[bar[UCha[{gO1}]], VZp, Cha[{gI2}]][PL]] - 
   sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[VWm]]*
     conj[Cp[bar[UCha[{gO2}]], VWm, Chi[{gI2}]][PL]]*
     Cp[bar[UCha[{gO1}]], VWm, Chi[{gI2}]][PL]], 
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], 
         Mass2[SHpp[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], SHpp[{gI1}], 
           ChiP[{gI2}]][PL]]*Cp[bar[UCha[{gO1}]], SHpp[{gI1}], ChiP[{gI2}]][
         PL]]]/2 - sum[gI1, 1, 2, sum[gI2, 1, 5, 
      B1[p^2, Mass2[Cha[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UCha[{gO2}]], Cha[{gI1}], Ah[{gI2}]][PL]]*
   ...
   sum[gI1, 1, 2, B1[p^2, Mass2[ChaP], Mass2[SHp0[{gI1}]]]*
      conj[Cp[bar[UCha[{gO2}]], conj[SHp0[{gI1}]], ChaP[{1}]][PL]]*
      Cp[bar[UCha[{gO1}]], conj[SHp0[{gI1}]], ChaP[{1}]][PL]]/2 - 
   sum[gI1, 1, 3, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Sv[{gI1}]]]*
       conj[Cp[bar[UCha[{gO2}]], conj[Sv[{gI1}]], Fe[{gI2}]][PL]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], Mass2[Hpm[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[Fe[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UFe[{gO2}]], Fe[{gI1}], Ah[{gI2}]][PR]]*
       Cp[bar[UFe[{gO1}]], Fe[{gI1}], Ah[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 5, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[hh[{gI1}]]]*
       conj[Cp[bar[UFe[{gO2}]], hh[{gI1}], Fe[{gI2}]][PR]]*
       Cp[bar[UFe[{gO1}]], hh[{gI1}], Fe[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 6, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Se[{gI1}]]]*
   ...
   sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[VZ]]*
     ...
     Cp[bar[UFe[{gO1}]], VZ, Fe[{gI2}]][PL]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[VZp]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 8, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Sd[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[Fd[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UFd[{gO2}]], Fd[{gI1}], Ah[{gI2}]][PR]]*
       Cp[bar[UFd[{gO1}]], Fd[{gI1}], Ah[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 5, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[hh[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sd[{gI1}]]]*
   ...
   sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[VZ]]*
     ...
     Cp[bar[UFd[{gO1}]], VZ, Fd[{gI2}]][PL]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[VZp]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], Mass2[Hpm[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[Fu[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UFu[{gO2}]], Fu[{gI1}], Ah[{gI2}]][PR]]*
       Cp[bar[UFu[{gO1}]], Fu[{gI1}], Ah[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 5, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], Mass2[hh[{gI1}]]]*
       conj[Cp[bar[UFu[{gO2}]], hh[{gI1}], Fu[{gI2}]][PR]]*
       Cp[bar[UFu[{gO1}]], hh[{gI1}], Fu[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 6, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Su[{gI1}]]]*
   ...
   sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], Mass2[VZ]]*
     ...
     Cp[bar[UFu[{gO1}]], VZ, Fu[{gI2}]][PL]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], Mass2[VZp]]*
 ...
 {sum[gI1, 1, 3, Mass[FDX[{gI1}]]*sum[gI2, 1, 5, 
      B0[p^2, Mass2[FDX[{gI1}]], Mass2[Ah[{gI2}]]]*
       conj[Cp[bar[UFDX[{gO2}]], FDX[{gI1}], Ah[{gI2}]][PL]]*
       Cp[bar[UFDX[{gO1}]], FDX[{gI1}], Ah[{gI2}]][PR]]] + 
   sum[gI1, 1, 5, sum[gI2, 1, 3, B0[p^2, Mass2[FDX[{gI2}]], Mass2[hh[{gI1}]]]*
      conj[Cp[bar[UFDX[{gO2}]], hh[{gI1}], FDX[{gI2}]][PL]]*Mass[FDX[{gI2}]]*
      Cp[bar[UFDX[{gO1}]], hh[{gI1}], FDX[{gI2}]][PR]]] + 
   sum[gI1, 1, 6, sum[gI2, 1, 8, B0[p^2, Mass2[Chi[{gI2}]], 
       Mass2[SDX[{gI1}]]]*conj[Cp[bar[UFDX[{gO2}]], SDX[{gI1}], Chi[{gI2}]][
        PL]]*Mass[Chi[{gI2}]]*Cp[bar[UFDX[{gO1}]], SDX[{gI1}], Chi[{gI2}]][
       PR]]] + (4*Mass[Glu]*sum[gI1, 1, 6, 
      B0[p^2, Mass2[Glu], Mass2[SDX[{gI1}]]]*
       conj[Cp[bar[UFDX[{gO2}]], SDX[{gI1}], Glu[{1}]][PL]]*
       Cp[bar[UFDX[{gO1}]], SDX[{gI1}], Glu[{1}]][PR]])/3 - 
   (16*sum[gI2, 1, 3, (-rMS/2 + B0[p^2, Mass2[FDX[{gI2}]], 0])*
       conj[Cp[bar[UFDX[{gO2}]], VG, FDX[{gI2}]][PR]]*Mass[FDX[{gI2}]]*
       Cp[bar[UFDX[{gO1}]], VG, FDX[{gI2}]][PL]])/3 - 
   4*sum[gI2, 1, 3, (-rMS/2 + B0[p^2, Mass2[FDX[{gI2}]], 0])*
      conj[Cp[bar[UFDX[{gO2}]], VP, FDX[{gI2}]][PR]]*Mass[FDX[{gI2}]]*
      Cp[bar[UFDX[{gO1}]], VP, FDX[{gI2}]][PL]] - 
   4*sum[gI2, 1, 3, (-rMS/2 + B0[p^2, Mass2[FDX[{gI2}]], Mass2[VZ]])*
      conj[Cp[bar[UFDX[{gO2}]], VZ, FDX[{gI2}]][PR]]*Mass[FDX[{gI2}]]*
      Cp[bar[UFDX[{gO1}]], VZ, FDX[{gI2}]][PL]] - 
   4*sum[gI2, 1, 3, (-rMS/2 + B0[p^2, Mass2[FDX[{gI2}]], Mass2[VZp]])*
      conj[Cp[bar[UFDX[{gO2}]], VZp, FDX[{gI2}]][PR]]*Mass[FDX[{gI2}]]*
      Cp[bar[UFDX[{gO1}]], VZp, FDX[{gI2}]][PL]], 
  -sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[FDX[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFDX[{gO2}]], FDX[{gI1}], Ah[{gI2}]][PR]]*
        Cp[bar[UFDX[{gO1}]], FDX[{gI1}], Ah[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 5, sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], Mass2[hh[{gI1}]]]*
       conj[Cp[bar[UFDX[{gO2}]], hh[{gI1}], FDX[{gI2}]][PR]]*
       Cp[bar[UFDX[{gO1}]], hh[{gI1}], FDX[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 6, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], 
        Mass2[SDX[{gI1}]]]*conj[Cp[bar[UFDX[{gO2}]], SDX[{gI1}], Chi[{gI2}]][
         PR]]*Cp[bar[UFDX[{gO1}]], SDX[{gI1}], Chi[{gI2}]][PR]]]/2 - 
   (2*sum[gI1, 1, 6, B1[p^2, Mass2[Glu], Mass2[SDX[{gI1}]]]*
       conj[Cp[bar[UFDX[{gO2}]], SDX[{gI1}], Glu[{1}]][PR]]*
       Cp[bar[UFDX[{gO1}]], SDX[{gI1}], Glu[{1}]][PR]])/3 - 
   (4*sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], 0]*
       conj[Cp[bar[UFDX[{gO2}]], VG, FDX[{gI2}]][PL]]*
       Cp[bar[UFDX[{gO1}]], VG, FDX[{gI2}]][PL]])/3 - 
   sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], 0]*
     conj[Cp[bar[UFDX[{gO2}]], VP, FDX[{gI2}]][PL]]*
     Cp[bar[UFDX[{gO1}]], VP, FDX[{gI2}]][PL]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], Mass2[VZ]]*
     conj[Cp[bar[UFDX[{gO2}]], VZ, FDX[{gI2}]][PL]]*
     Cp[bar[UFDX[{gO1}]], VZ, FDX[{gI2}]][PL]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], Mass2[VZp]]*
     conj[Cp[bar[UFDX[{gO2}]], VZp, FDX[{gI2}]][PL]]*
     Cp[bar[UFDX[{gO1}]], VZp, FDX[{gI2}]][PL]], 
  -sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[FDX[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFDX[{gO2}]], FDX[{gI1}], Ah[{gI2}]][PL]]*
        Cp[bar[UFDX[{gO1}]], FDX[{gI1}], Ah[{gI2}]][PL]]]/2 - 
   sum[gI1, 1, 5, sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], Mass2[hh[{gI1}]]]*
       conj[Cp[bar[UFDX[{gO2}]], hh[{gI1}], FDX[{gI2}]][PL]]*
       Cp[bar[UFDX[{gO1}]], hh[{gI1}], FDX[{gI2}]][PL]]]/2 - 
   sum[gI1, 1, 6, sum[gI2, 1, 8, B1[p^2, Mass2[Chi[{gI2}]], 
        Mass2[SDX[{gI1}]]]*conj[Cp[bar[UFDX[{gO2}]], SDX[{gI1}], Chi[{gI2}]][
         PL]]*Cp[bar[UFDX[{gO1}]], SDX[{gI1}], Chi[{gI2}]][PL]]]/2 - 
   (2*sum[gI1, 1, 6, B1[p^2, Mass2[Glu], Mass2[SDX[{gI1}]]]*
       conj[Cp[bar[UFDX[{gO2}]], SDX[{gI1}], Glu[{1}]][PL]]*
       Cp[bar[UFDX[{gO1}]], SDX[{gI1}], Glu[{1}]][PL]])/3 - 
   (4*sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], 0]*
       conj[Cp[bar[UFDX[{gO2}]], VG, FDX[{gI2}]][PR]]*
       Cp[bar[UFDX[{gO1}]], VG, FDX[{gI2}]][PR]])/3 - 
   sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], 0]*
     conj[Cp[bar[UFDX[{gO2}]], VP, FDX[{gI2}]][PR]]*
     Cp[bar[UFDX[{gO1}]], VP, FDX[{gI2}]][PR]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], Mass2[VZ]]*
     conj[Cp[bar[UFDX[{gO2}]], VZ, FDX[{gI2}]][PR]]*
     Cp[bar[UFDX[{gO1}]], VZ, FDX[{gI2}]][PR]] - 
   sum[gI2, 1, 3, B1[p^2, Mass2[FDX[{gI2}]], Mass2[VZp]]*
     conj[Cp[bar[UFDX[{gO2}]], VZp, FDX[{gI2}]][PR]]*
     Cp[bar[UFDX[{gO1}]], VZp, FDX[{gI2}]][PR]]}, 
 4*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], conj[VWm], VWm]*
   (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
  2*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], VZ, VZ]*
   (A0[Mass2[VZ]] - (rMS*Mass2[VZ])/2) + 
  2*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], VZp, VZp]*
   (A0[Mass2[VZp]] - (rMS*Mass2[VZp])/2) - 
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
     conj[SHp0[{gI1}]], SHp0[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHpp[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
     conj[SHpp[{gI1}]], SHpp[{gI1}]]] + sum[gI1, 1, 2, 
   sum[gI2, 1, 2, B0[p^2, Mass2[Hpm[{gI1}]], Mass2[SHpp[{gI2}]]]*
     conj[Cp[conj[USHp0[{gO2}]], conj[Hpm[{gI1}]], SHpp[{gI2}]]]*
     Cp[conj[USHp0[{gO1}]], conj[Hpm[{gI1}]], SHpp[{gI2}]]]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 5, B0[p^2, Mass2[SHp0[{gI1}]], Mass2[hh[{gI2}]]]*
     conj[Cp[conj[USHp0[{gO2}]], SHp0[{gI1}], hh[{gI2}]]]*
     Cp[conj[USHp0[{gO1}]], SHp0[{gI1}], hh[{gI2}]]]] - 
  sum[gI1, 1, 2, Mass[ChiP[{gI1}]]*sum[gI2, 1, 8, 
     B0[p^2, Mass2[ChiP[{gI1}]], Mass2[Chi[{gI2}]]]*Mass[Chi[{gI2}]]*
      (conj[Cp[conj[USHp0[{gO2}]], ChiP[{gI1}], Chi[{gI2}]][PR]]*
        Cp[conj[USHp0[{gO1}]], ChiP[{gI1}], Chi[{gI2}]][PL] + 
       conj[Cp[conj[USHp0[{gO2}]], ChiP[{gI1}], Chi[{gI2}]][PL]]*
        Cp[conj[USHp0[{gO1}]], ChiP[{gI1}], Chi[{gI2}]][PR])]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 8, G0[p^2, Mass2[ChiP[{gI1}]], 
       Mass2[Chi[{gI2}]]]*(conj[Cp[conj[USHp0[{gO2}]], ChiP[{gI1}], 
           Chi[{gI2}]][PL]]*Cp[conj[USHp0[{gO1}]], ChiP[{gI1}], Chi[{gI2}]][
         PL] + conj[Cp[conj[USHp0[{gO2}]], ChiP[{gI1}], Chi[{gI2}]][PR]]*
        Cp[conj[USHp0[{gO1}]], ChiP[{gI1}], Chi[{gI2}]][PR])]]/2 - 
  2*Mass[ChaP]*sum[gI1, 1, 2, B0[p^2, Mass2[Cha[{gI1}]], Mass2[ChaP]]*
     Mass[Cha[{gI1}]]*(conj[Cp[conj[USHp0[{gO2}]], bar[Cha[{gI1}]], 
          ChaP[{1}]][PR]]*Cp[conj[USHp0[{gO1}]], bar[Cha[{gI1}]], ChaP[{1}]][
        PL] + conj[Cp[conj[USHp0[{gO2}]], bar[Cha[{gI1}]], ChaP[{1}]][PL]]*
       Cp[conj[USHp0[{gO1}]], bar[Cha[{gI1}]], ChaP[{1}]][PR])] + 
  sum[gI1, 1, 2, G0[p^2, Mass2[Cha[{gI1}]], Mass2[ChaP]]*
    (conj[Cp[conj[USHp0[{gO2}]], bar[Cha[{gI1}]], ChaP[{1}]][PL]]*
      Cp[conj[USHp0[{gO1}]], bar[Cha[{gI1}]], ChaP[{1}]][PL] + 
     conj[Cp[conj[USHp0[{gO2}]], bar[Cha[{gI1}]], ChaP[{1}]][PR]]*
      Cp[conj[USHp0[{gO1}]], bar[Cha[{gI1}]], ChaP[{1}]][PR])] - 
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
     conj[Sv[{gI1}]], Sv[{gI1}]]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
   A0[Mass2[Se[{gI1}]]]*Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], conj[Se[{gI1}]], 
     Se[{gI1}]]] - 3*sum[gI1, 1, 6, A0[Mass2[Su[{gI1}]]]*
     Cp[USHp0[{gO1}], conj[USHp0[{gO2}]], conj[Su[{gI1}]], Su[{gI1}]]] + 
  sum[gI2, 1, 2, conj[Cp[conj[USHp0[{gO2}]], VZ, SHp0[{gI2}]]]*
    Cp[conj[USHp0[{gO1}]], VZ, SHp0[{gI2}]]*F0[p^2, Mass2[SHp0[{gI2}]], 
     Mass2[VZ]]] + sum[gI2, 1, 2, 
   conj[Cp[conj[USHp0[{gO2}]], VZp, SHp0[{gI2}]]]*Cp[conj[USHp0[{gO1}]], VZp, 
     SHp0[{gI2}]]*F0[p^2, Mass2[SHp0[{gI2}]], Mass2[VZp]]] + 
  sum[gI2, 1, 2, conj[Cp[conj[USHp0[{gO2}]], conj[VWm], SHpp[{gI2}]]]*
    Cp[conj[USHp0[{gO1}]], conj[VWm], SHpp[{gI2}]]*
    F0[p^2, Mass2[SHpp[{gI2}]], Mass2[VWm]]], 
 4*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], conj[VWm], VWm]*
   (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
  2*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], VZ, VZ]*
   (A0[Mass2[VZ]] - (rMS*Mass2[VZ])/2) + 
  2*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], VZp, VZp]*
   (A0[Mass2[VZp]] - (rMS*Mass2[VZp])/2) - 
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
     conj[Hpm[{gI1}]], Hpm[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHp0[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
     conj[SHp0[{gI1}]], SHp0[{gI1}]]] - sum[gI1, 1, 2, 
   A0[Mass2[SHpp[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
     conj[SHpp[{gI1}]], SHpp[{gI1}]]] + sum[gI1, 1, 2, 
   sum[gI2, 1, 2, B0[p^2, Mass2[SHp0[{gI1}]], Mass2[Hpm[{gI2}]]]*
     conj[Cp[conj[USHpp[{gO2}]], SHp0[{gI1}], Hpm[{gI2}]]]*
     Cp[conj[USHpp[{gO1}]], SHp0[{gI1}], Hpm[{gI2}]]]] - 
  2*sum[gI1, 1, 2, Mass[ChiP[{gI1}]]*sum[gI2, 1, 2, 
      B0[p^2, Mass2[ChiP[{gI1}]], Mass2[Cha[{gI2}]]]*Mass[Cha[{gI2}]]*
       (conj[Cp[conj[USHpp[{gO2}]], ChiP[{gI1}], Cha[{gI2}]][PR]]*
         Cp[conj[USHpp[{gO1}]], ChiP[{gI1}], Cha[{gI2}]][PL] + 
        conj[Cp[conj[USHpp[{gO2}]], ChiP[{gI1}], Cha[{gI2}]][PL]]*
         Cp[conj[USHpp[{gO1}]], ChiP[{gI1}], Cha[{gI2}]][PR])]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 2, G0[p^2, Mass2[ChiP[{gI1}]], 
      Mass2[Cha[{gI2}]]]*
     (conj[Cp[conj[USHpp[{gO2}]], ChiP[{gI1}], Cha[{gI2}]][PL]]*
       Cp[conj[USHpp[{gO1}]], ChiP[{gI1}], Cha[{gI2}]][PL] + 
      conj[Cp[conj[USHpp[{gO2}]], ChiP[{gI1}], Cha[{gI2}]][PR]]*
       Cp[conj[USHpp[{gO1}]], ChiP[{gI1}], Cha[{gI2}]][PR])]] + 
  sum[gI1, 1, 2, sum[gI2, 1, 5, B0[p^2, Mass2[SHpp[{gI1}]], Mass2[hh[{gI2}]]]*
     conj[Cp[conj[USHpp[{gO2}]], SHpp[{gI1}], hh[{gI2}]]]*
     Cp[conj[USHpp[{gO1}]], SHpp[{gI1}], hh[{gI2}]]]] - 
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
     conj[Sv[{gI1}]], Sv[{gI1}]]] - 
  sum[gI1, 1, 5, A0[Mass2[Ah[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - 
  sum[gI1, 1, 5, A0[Mass2[hh[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 - 
  3*sum[gI1, 1, 6, A0[Mass2[Sd[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
      conj[Sd[{gI1}]], Sd[{gI1}]]] - 
  3*sum[gI1, 1, 6, A0[Mass2[SDX[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], 
      conj[SDX[{gI1}]], SDX[{gI1}]]] - sum[gI1, 1, 6, 
   A0[Mass2[Se[{gI1}]]]*Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], conj[Se[{gI1}]], 
     Se[{gI1}]]] - 3*sum[gI1, 1, 6, A0[Mass2[Su[{gI1}]]]*
     Cp[USHpp[{gO1}], conj[USHpp[{gO2}]], conj[Su[{gI1}]], Su[{gI1}]]] - 
  2*Mass[ChaP]*sum[gI1, 1, 8, B0[p^2, Mass2[Chi[{gI1}]], Mass2[ChaP]]*
     Mass[Chi[{gI1}]]*(conj[Cp[conj[USHpp[{gO2}]], Chi[{gI1}], ChaP[{1}]][
         PR]]*Cp[conj[USHpp[{gO1}]], Chi[{gI1}], ChaP[{1}]][PL] + 
      conj[Cp[conj[USHpp[{gO2}]], Chi[{gI1}], ChaP[{1}]][PL]]*
       Cp[conj[USHpp[{gO1}]], Chi[{gI1}], ChaP[{1}]][PR])] + 
  sum[gI1, 1, 8, G0[p^2, Mass2[Chi[{gI1}]], Mass2[ChaP]]*
    (conj[Cp[conj[USHpp[{gO2}]], Chi[{gI1}], ChaP[{1}]][PL]]*
      Cp[conj[USHpp[{gO1}]], Chi[{gI1}], ChaP[{1}]][PL] + 
     conj[Cp[conj[USHpp[{gO2}]], Chi[{gI1}], ChaP[{1}]][PR]]*
      Cp[conj[USHpp[{gO1}]], Chi[{gI1}], ChaP[{1}]][PR])] + 
  sum[gI2, 1, 2, conj[Cp[conj[USHpp[{gO2}]], VWm, SHp0[{gI2}]]]*
    Cp[conj[USHpp[{gO1}]], VWm, SHp0[{gI2}]]*F0[p^2, Mass2[SHp0[{gI2}]], 
     Mass2[VWm]]] + sum[gI2, 1, 2, 
   conj[Cp[conj[USHpp[{gO2}]], VP, SHpp[{gI2}]]]*Cp[conj[USHpp[{gO1}]], VP, 
     SHpp[{gI2}]]*F0[p^2, Mass2[SHpp[{gI2}]], 0]] + 
  sum[gI2, 1, 2, conj[Cp[conj[USHpp[{gO2}]], VZ, SHpp[{gI2}]]]*
    Cp[conj[USHpp[{gO1}]], VZ, SHpp[{gI2}]]*F0[p^2, Mass2[SHpp[{gI2}]], 
     Mass2[VZ]]] + sum[gI2, 1, 2, 
   conj[Cp[conj[USHpp[{gO2}]], VZp, SHpp[{gI2}]]]*Cp[conj[USHpp[{gO1}]], VZp, 
     SHpp[{gI2}]]*F0[p^2, Mass2[SHpp[{gI2}]], Mass2[VZp]]], 
 {2*sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[Cha[{gI2}]], 
        Mass2[SHpp[{gI1}]]]*conj[Cp[UChiP[{gO2}], conj[SHpp[{gI1}]], 
          Cha[{gI2}]][PL]]*Mass[Cha[{gI2}]]*
       Cp[UChiP[{gO1}], conj[SHpp[{gI1}]], Cha[{gI2}]][PR]]] + 
   2*sum[gI1, 1, 2, sum[gI2, 1, 8, B0[p^2, Mass2[Chi[{gI2}]], 
        Mass2[SHp0[{gI1}]]]*conj[Cp[UChiP[{gO2}], conj[SHp0[{gI1}]], 
          Chi[{gI2}]][PL]]*Mass[Chi[{gI2}]]*
       Cp[UChiP[{gO1}], conj[SHp0[{gI1}]], Chi[{gI2}]][PR]]] - 
   4*sum[gI2, 1, 2, (-rMS/2 + B0[p^2, Mass2[ChiP[{gI2}]], Mass2[VZ]])*
      conj[Cp[UChiP[{gO2}], VZ, ChiP[{gI2}]][PR]]*Mass[ChiP[{gI2}]]*
      Cp[UChiP[{gO1}], VZ, ChiP[{gI2}]][PL]] - 
   4*sum[gI2, 1, 2, (-rMS/2 + B0[p^2, Mass2[ChiP[{gI2}]], Mass2[VZp]])*
      conj[Cp[UChiP[{gO2}], VZp, ChiP[{gI2}]][PR]]*Mass[ChiP[{gI2}]]*
      Cp[UChiP[{gO1}], VZp, ChiP[{gI2}]][PL]] - 
   8*(-rMS/2 + B0[p^2, Mass2[ChaP], Mass2[VWm]])*
    conj[Cp[UChiP[{gO2}], conj[VWm], ChaP[{1}]][PR]]*Mass[ChaP]*
    Cp[UChiP[{gO1}], conj[VWm], ChaP[{1}]][PL], 
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
        Mass2[SHpp[{gI1}]]]*conj[Cp[UChiP[{gO2}], conj[SHpp[{gI1}]], 
          Cha[{gI2}]][PR]]*Cp[UChiP[{gO1}], conj[SHpp[{gI1}]], Cha[{gI2}]][
        PR]]] - sum[gI1, 1, 2, sum[gI2, 1, 8, 
     B1[p^2, Mass2[Chi[{gI2}]], Mass2[SHp0[{gI1}]]]*
      conj[Cp[UChiP[{gO2}], conj[SHp0[{gI1}]], Chi[{gI2}]][PR]]*
      Cp[UChiP[{gO1}], conj[SHp0[{gI1}]], Chi[{gI2}]][PR]]] - 
   sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], Mass2[VZ]]*
     conj[Cp[UChiP[{gO2}], VZ, ChiP[{gI2}]][PL]]*
     Cp[UChiP[{gO1}], VZ, ChiP[{gI2}]][PL]] - 
   sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], Mass2[VZp]]*
     conj[Cp[UChiP[{gO2}], VZp, ChiP[{gI2}]][PL]]*
     Cp[UChiP[{gO1}], VZp, ChiP[{gI2}]][PL]] - 
   2*B1[p^2, Mass2[ChaP], Mass2[VWm]]*
    conj[Cp[UChiP[{gO2}], conj[VWm], ChaP[{1}]][PL]]*
    Cp[UChiP[{gO1}], conj[VWm], ChaP[{1}]][PL], 
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
        Mass2[SHpp[{gI1}]]]*conj[Cp[UChiP[{gO2}], conj[SHpp[{gI1}]], 
          Cha[{gI2}]][PL]]*Cp[UChiP[{gO1}], conj[SHpp[{gI1}]], Cha[{gI2}]][
        PL]]] - sum[gI1, 1, 2, sum[gI2, 1, 8, 
     B1[p^2, Mass2[Chi[{gI2}]], Mass2[SHp0[{gI1}]]]*
      conj[Cp[UChiP[{gO2}], conj[SHp0[{gI1}]], Chi[{gI2}]][PL]]*
      Cp[UChiP[{gO1}], conj[SHp0[{gI1}]], Chi[{gI2}]][PL]]] - 
   sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], Mass2[VZ]]*
     conj[Cp[UChiP[{gO2}], VZ, ChiP[{gI2}]][PR]]*
     Cp[UChiP[{gO1}], VZ, ChiP[{gI2}]][PR]] - 
   sum[gI2, 1, 2, B1[p^2, Mass2[ChiP[{gI2}]], Mass2[VZp]]*
     conj[Cp[UChiP[{gO2}], VZp, ChiP[{gI2}]][PR]]*
     Cp[UChiP[{gO1}], VZp, ChiP[{gI2}]][PR]] - 
   2*B1[p^2, Mass2[ChaP], Mass2[VWm]]*
    conj[Cp[UChiP[{gO2}], conj[VWm], ChaP[{1}]][PR]]*
    Cp[UChiP[{gO1}], conj[VWm], ChaP[{1}]][PR]}}
