...
// File generated at Wed 9 Jul 2014 13:58:22
 ...
 */
Eigen::Matrix<double,2,2> NE6SSM_susy_parameters::calc_beta_Lambda12_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> NE6SSM_susy_parameters::calc_beta_Lambda12_two_loop(const Susy_traces& susy_traces) const
{
   const auto QS = INPUT(QS);
