 ...
 */
double NE6SSM_susy_parameters::calc_beta_SigmaL_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NE6SSM_susy_parameters::calc_beta_SigmaL_two_loop(const Susy_traces& susy_traces) const
{
