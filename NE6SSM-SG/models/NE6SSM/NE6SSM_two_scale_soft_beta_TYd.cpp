...
// File generated at Wed 9 Jul 2014 14:03:57
...
Eigen::Matrix<double,3,3> NE6SSM_soft_parameters::calc_beta_TYd_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYd = twoLoop*(4.588888888888889*Power(g1,4)*TYd + 6.825*Power(
      ...
      *tracefdAdjfdTfdAdjfd + 1800*tracefdAdjfdTfuAdjfu + 1800*
      ...
      traceYdAdjYd*Sqr(g1p) - 180*MassBp*traceYeAdjYe*Sqr(g1p) + 294*MassB*Sqr(
      g1)*Sqr(g1p) + 294*MassBp*Sqr(g1)*Sqr(g1p) + 900*MassB*Sqr(g1)*Sqr(g2) +
