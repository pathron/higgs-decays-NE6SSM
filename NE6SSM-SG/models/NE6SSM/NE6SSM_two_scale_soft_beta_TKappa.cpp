...
// File generated at Tue 8 Jul 2014 14:46:35
...
Eigen::Matrix<double,3,3> NE6SSM_soft_parameters::calc_beta_TKappa_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TKappa = twoLoop*(2.5955555555555554*Power(g1,4)*TKappa + 6.3525*
      ...
      *tracegDAdjKappaKappaAdjgD*TKappa - 2*tracehEAdjLambda12Lambda12AdjhE*
      ...
      TKappa + 0.17333333333333334*Sqr(g1)*Sqr(g1p)*TKappa + 6*
      ...
      Sqr(g1p) + 2340*MassBp*traceLambda12AdjLambda12*Sqr(g1p) + 312*MassB*Sqr(
      g1)*Sqr(g1p) + 312*MassBp*Sqr(g1)*Sqr(g1p) - 10800*
