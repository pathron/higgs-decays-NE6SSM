...
public:
   ...
   NE6SSM_susy_parameters(double scale_, double loops_, double thresholds_, const NE6SSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,2>& hE_
