...
// File generated at Fri 20 Jun 2014 21:37:55
...
void NE6SSM_slha_io::fill(NE6SSM<T>& model) const
{
   ...
   {
      DEFINE_PARAMETER(Yu);
      const double tmp_scale = slha_io.read_block("Yu", Yu);
      model.set_Yu(Yu);
   ...
   {
      DEFINE_PARAMETER(Yd);
      const double tmp_scale = slha_io.read_block("Yd", Yd);
      model.set_Yd(Yd);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   {
      DEFINE_PARAMETER(Ye);
      const double tmp_scale = slha_io.read_block("Ye", Ye);
      model.set_Ye(Ye);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("Te", TYe);
      model.set_TYe(TYe);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("Td", TYd);
      model.set_TYd(TYd);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("Tu", TYu);
      model.set_TYu(TYu);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   model.set_LXiF(slha_io.read_entry("HMIX", 34));
   {
      ...
      const double tmp_scale = slha_io.read_block("MSQ2", mq2);
      model.set_mq2(mq2);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("MSE2", me2);
      model.set_me2(me2);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("MSL2", ml2);
      model.set_ml2(ml2);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("MSU2", mu2);
      model.set_mu2(mu2);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("MSD2", md2);
      model.set_md2(md2);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   model.set_mHu2(slha_io.read_entry("MSOFT", 22));
   {
      ...
      const double tmp_scale = slha_io.read_block("mX2", mDx2);
      model.set_mDx2(mDx2);
      if (!is_zero(tmp_scale))
         scale = tmp_scale;
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("mXBar2", mDxbar2);
   ...
   model.set_vphi(slha_io.read_entry("ESIXRUN", 13));
   {
      ...
      const double tmp_scale = slha_io.read_block("ESIXKAPPA", Kappa);
   ...
   }
   {
      ...
      const double tmp_scale = slha_io.read_block("ESIXTKAPPA", TKappa);
