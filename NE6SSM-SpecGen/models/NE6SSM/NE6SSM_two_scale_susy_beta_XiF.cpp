 ...
 */
double NE6SSM_susy_parameters::calc_beta_XiF_one_loop(const Susy_traces& susy_traces) const
{


   double beta_XiF;

   beta_XiF = oneOver16PiSqr*(2*AbsSqr(KappaPr) + AbsSqr(Sigmax))*XiF;
 ...
 */
double NE6SSM_susy_parameters::calc_beta_XiF_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_XiF = -0.1*twoLoop*XiF*(40*AbsSqr(KappaPr)*AbsSqr(Sigmax) +
