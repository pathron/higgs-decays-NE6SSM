...
// File generated at Fri 20 Jun 2014 21:37:50
 ...
 */
Eigen::Matrix<double,3,3> NE6SSM_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NE6SSM_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = twoLoop*(-12*traceconjTYdTpTYd*(Yd*Yd.adjoint()) - 4*
      ...
      TLambdax)*(Yd*Yd.adjoint()) + 0.8*mHd2*Sqr(g1)*(Yd*Yd.adjoint()) + 1.2*
      mHd2*Sqr(g1p)*(Yd*Yd.adjoint()) + 12*mHd2*Sqr(g2)*(Yd*Yd.adjoint()) + 24*
      AbsSqr(MassWB)*Sqr(g2)*(Yd*Yd.adjoint()) - 12*traceAdjYdTYd*(Yd*(TYd)
      .adjoint()) - 4*traceAdjYeTYe*(Yd*(TYd).adjoint()) - 0.8*MassB*Sqr(g1)*(
      Yd*(TYd).adjoint()) - 1.2*MassBp*Sqr(g1p)*(Yd*(TYd).adjoint()) - 12*
      MassWB*Sqr(g2)*(Yd*(TYd).adjoint()) - 4*Conj(Lambdax)*TLambdax*(Yd*(TYd)
      ...
      *(TYd*Yd.adjoint()) - 4*Conj(TLambdax)*Lambdax*(TYd*Yd.adjoint()) - 12*
      ...
      TYd*(TYd).adjoint()) + 0.8*Sqr(g1)*(TYd*(TYd).adjoint()) + 1.2*Sqr(g1p)*(
      TYd*(TYd).adjoint()) + 12*Sqr(g2)*(TYd*(TYd).adjoint()) - 6*traceYdAdjYd*
      (md2*Yd*Yd.adjoint()) - 2*traceYeAdjYe*(md2*Yd*Yd.adjoint()) - 2*AbsSqr(
      Lambdax)*(md2*Yd*Yd.adjoint()) + 0.4*Sqr(g1)*(md2*Yd*Yd.adjoint()) + 0.6*
      Sqr(g1p)*(md2*Yd*Yd.adjoint()) + 6*Sqr(g2)*(md2*Yd*Yd.adjoint()) - 12*
      ...
      *Yd.adjoint()*md2) - 2*AbsSqr(Lambdax)*(Yd*Yd.adjoint()*md2) + 0.4*Sqr(g1
      )*(Yd*Yd.adjoint()*md2) + 0.6*Sqr(g1p)*(Yd*Yd.adjoint()*md2) + 6*Sqr(g2)*
      ...
      *g1p*Tr2U114*UNITMATRIX(3) + 0.6531972647421809*g1*g1p*Tr2U141*UNITMATRIX
      (3) + 2.065591117977289*g1*Tr31*UNITMATRIX(3) + 2.5298221281347035*g1p*
      Tr34*UNITMATRIX(3) + 53.333333333333336*Power(g3,4)*AbsSqr(MassG)*
      UNITMATRIX(3) + 0.5333333333333333*Tr2U111*Sqr(g1)*UNITMATRIX(3) + 0.8*
      ...
      *Sqr(g3)*UNITMATRIX(3) + 1.4222222222222223*MassB*Conj(MassG)*Sqr(g1)*Sqr
      (g3)*UNITMATRIX(3) + 4.266666666666667*AbsSqr(MassG)*Sqr(g1p)*Sqr(g3)*
      ...
      Yd.adjoint()) - 45*(TYd*Yd.adjoint()) + (768*MassB*Sqr(g1) - 21*(2*MassB
      + MassBp)*Sqr(g1p) + 80*(2*MassB + MassG)*Sqr(g3))*UNITMATRIX(3)) +
      0.006666666666666667*Conj(MassBp)*Sqr(g1p)*(180*(2*MassBp*(Yd*Yd.adjoint(
      )) - TYd*Yd.adjoint()) + (-56*(MassB + 2*MassBp)*Sqr(g1) + 320*(2*MassBp
      + MassG)*Sqr(g3) + 9*MassBp*Sqr(g1p)*(257 + 2*Sqr(QS)))*UNITMATRIX(3)));
